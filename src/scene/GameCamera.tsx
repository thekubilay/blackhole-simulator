 ...
 * — ŞİMDİLİK KAPALI (kullanıcı isteği, 2026-08-30): aşağıdaki yorum
 * bloklarını açınca geri gelir */
// const LOOK_FRAC = 0.3
...
export function GameCamera({ game }: { game: GameController }) {
  ...
  // POV serbest bakış KAPALI — açmak için bu bloğu ve useFrame'deki sway
  // bloğunu yorumdan çıkar
  ...
  useFrame((_, delta) => {
    ...
    // POV serbest bakış KAPALI: fare konumuna doğru hafif dönüş (lookAt
    // ÜSTÜNE, yerel eksenlerde) — çapa ve hedef takibi bozulmaz, bakış esner
